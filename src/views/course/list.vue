<template>
  <div class="app-container">
    ...
    class="demo-form-inline">
      <el-form-item>
        <el-input v-model="headForm.idText" placeholder="请输入课号或开课名"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" icon="el-icon-search" @click="handleSearch()">搜索</el-button>
      </el-form-item>
      <el-form-item>
        <el-button icon="el-icon-plus" @click="handleAdd()">新增开课</el-button>
      </el-form-item>
      <el-form-item>
    ...
    <el-dialog title="修改开课信息" :visible.sync="dialogEditVisible">
      <el-form :model="selectTable" :rules="rules" ref="editForm">
        ...
        <el-form-item label="课程代码" label-width="100px" prop="subject">
        ...
        <el-form-item label="任课教师" label-width="100px" prop="teacher">
        ...
        <el-form-item label="学期" label-width="100px" prop="term">
...
<script>
import { downloadReport, getCourseCount , addCourse, deleteCourse, getCourses, updateCourse, searchCourses } from '@/api/course'
...
export default {
  ...
  methods: {
    ...
    async getCourses(){
      getCourses({offset: this.offset, limit: this.limit}).then(response => {
        this.tableData = [];
