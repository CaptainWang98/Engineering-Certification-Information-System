    ...
    <el-tabs class="table_container">
      <el-tab-pane label="评价环节">
        <div class="table_container">
          ...
          border>
            ...
            <el-table-column label="操作">
              ...
              <template slot-scope="scope">
                ...
                size="mini"
                type="primary"
                @click="handleEditEval(scope.row)">编辑</el-button>
                <el-button
                size="mini"
                type="danger"
                @click="handleDeleteEval(scope.$index, scope.row)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
          <el-dialog title="新增评价环节" :visible.sync="dialogAddEvalVisible">
            <el-form :model="newEval" ref="addEvalForm" :rules="evalRules">
              ...
              <el-form-item label="满分" label-width="100px" prop="score">
                <el-input type="number" v-model.number="newEval.score" auto-complete="off"></el-input>
              </el-form-item>
            </el-form>
          ...
          <el-dialog title="修改评价环节" :visible.sync="dialogEditEvalVisible">
            <el-form :model="selectEval" ref="editEvalForm" :rules="evalRules">
              <el-form-item label="类型" label-width="100px" prop="type">
              ...
              <el-form-item label="满分" label-width="100px" prop="score">
                <el-input type="number" v-model="selectEval.score" auto-complete="off"></el-input>
              </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
      ...
      <el-tab-pane label="对应关系">
        <div class="table_container">
          ...
          border>
            <el-table-column 
            label="序号" 
            prop="e2gindex"></el-table-column>
            <el-table-column 
            label="评价环节" 
            prop="eval.type"></el-table-column>
            <el-table-column
            label="课程目标"
            prop="subjectGoal.note"></el-table-column>
            <el-table-column
            label="比例"
            ...
            <el-table-column label="操作">
              ...
              <template slot-scope="scope">
                ...
                size="mini"
                type="primary"
                @click="handleEditE2G(scope.row)">编辑</el-button>
                <el-button
                size="mini"
                type="danger"
                @click="handleDeleteE2G(scope.$index, scope.row)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
          <el-dialog title="新增对应关系" :visible.sync="dialogAddE2GVisible">
            <el-form :model="newE2G" ref="addE2GForm" :rules="E2GRules">
              <el-form-item label="序号" label-width="100px" prop="e2gindex">
                <el-input v-model="newE2G.e2gindex" auto-complete="off"></el-input>
              </el-form-item>
              <el-form-item label="课程目标" label-width="100px" prop="subjectGoal">
                <el-autocomplete popper-class="my-autocomplete" v-model="newE2G.subjectGoal" placeholder="输入课程目标序号" :fetch-suggestions="querySearchSubjectGoal">
                  <i
              ...
              <el-form-item label="支撑占比" label-width="100px" prop="percentage">
                <el-input type="number" v-model.number="newE2G.percentage" auto-complete="off"></el-input>
              </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
          ...
          <el-dialog title="编辑对应关系" :visible.sync="dialogEditE2GVisible">
            <el-form :model="selectE2G" ref="editE2GForm" :rules="E2GRules">
              <el-form-item label="序号" label-width="100px" prop="e2gindex">
                <el-input v-model="selectE2G.e2gindex" auto-complete="off"></el-input>
              </el-form-item>
              <el-form-item label="课程目标" label-width="100px" prop="subjectGoal">
                <el-autocomplete popper-class="my-autocomplete" v-model="selectE2G.subjectGoal" placeholder="输入课程目标序号" :fetch-suggestions="querySearchSubjectGoal">
                  <i
                    class="el-icon-edit el-input__icon"
                    slot="suffix">
                  </i>
              ...
              <el-form-item label="支撑占比" label-width="100px" prop="percentage">
                <el-input type="number" v-model.number="selectE2G.percentage" auto-complete="off"></el-input>
              </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
      ...
      <el-tab-pane label="成绩管理">
        ...
        class="demo-form-inline">
          <el-form-item>
            <el-input v-model="headForm.idText" placeholder="学号"></el-input>
          </el-form-item>
          <el-form-item>
        ...
        <div class="table_container">
          ...
          border>
            <el-table-column 
            label="学号" 
            prop="student"></el-table-column>
            <el-table-column
            label="对应评价环节"
            prop="eval"></el-table-column>
            <el-table-column
            label="得分"
            prop="score"></el-table-column>
            <el-table-column label="操作">
              <template slot-scope="scope">
                ...
                size="mini"
                type="primary"
                @click="handleEditScore(scope.row)">编辑</el-button>
                <el-button
                size="mini"
                type="danger"
                @click="handleDeleteScore(scope.$index, scope.row)">删除</el-button>
              </template>
            </el-table-column>
          </el-table>
          ...
          <el-dialog title="新增成绩" :visible.sync="dialogAddScoreVisible">
            <el-form :model="selectScore" ref="addScoreForm" :rules="scoreRules">
              ...
              <el-form-item label="得分" label-width="100px" prop="score">
                <el-input type="number" v-model="selectScore.score" auto-complete="off"></el-input>
              </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
          ...
          <el-dialog title="修改成绩" :visible.sync="dialogEditScoreVisible">
            <el-form :model="selectScore" ref="editScoreForm" :rules="scoreRules">
              <el-form-item label="学生" label-width="100px" prop="student">
                <el-input v-model="selectScore.student" auto-complete="off"></el-input>
              </el-form-item>
              <el-form-item label="评价环节类型" label-width="100px" prop="eval">
                <el-select v-model="selectScore.eval" placeholder="请选择">
                  <el-option
      ...
      <el-tab-pane label="课程考核结果统计图">
        <div class="table_container">
          <div id="barChart" :style="{width: '800px', height: '800px'}"></div>
        </div>
      </el-tab-pane>
  ...
  data() {
    return {
      ...
      E2GRules: {
        ...
        percentage: [
          { required: true, message: '非空', trigger: 'blur' },
          { type: "number", min: 0.1, max: 1, message: '输入0~1的小数', trigger: 'blur' },
        ],
      },
      viewPointRules: {
        note: [
  ...
  methods: {
    ...
    loadScatterDate(){
      getGoalScore({aclass: this.courseId, goal: this.currentScatterChart.goalId}).then(response => {
        let scatterChart = this.$echarts.init(document.getElementById('scatterChart'));
